...
Add `[functionalbytes/mount-lite "2.1.4"]` or `functionalbytes/mount-lite {:mvn/version "2.1.4"}` to your dependencies and make sure Clojars is one of your repositories.
